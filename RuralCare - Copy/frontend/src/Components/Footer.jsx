            ...
            <div className='footer1'>
                ...
                <div className='footer3'>
                    <div className='footer4'>
                        ...
                        <div className='footer5'>
                            <span><i className="fa fa-envelope" style={{ fontSize: '10px' }}></i></span><span style={{ marginLeft: '3%' }}><a href='mailto:ruralcare@gmai.com'>ruralcare@gmail.com</a></span>
                        </div>
                    </div>
                    <div className='footer4'>
                        <h2>Latest News</h2>
                        <div className='footer5'>
                            <h2 style={{ fontSize: '15px' }}>RuralCare Hospital Recognized for Excellence in Patient Care</h2>
                            <p>March 20 , 2024</p>
                        </div>
                        <div className='footer5'>
                            <h2 style={{ fontSize: '15px' }}>RuralCare Hospital Expands Services with New Cardiology Department</h2>
                            <p>March 01 , 2024</p>
                        </div>
                        <div className='footer5'>
                            <h2 style={{ fontSize: '15px' }}>RuralCare Hospital Launches Telemedicine Services for Remote Communities</h2>
                            <p>January 28 , 2024</p>
                        </div>
                    </div>
                    <div className='footer4'>
